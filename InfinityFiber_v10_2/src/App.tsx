...
import SplashCliente from '@/screens/cliente/SplashCliente';
...
function CadastroEmBreve(){return (<View style={{flex:1,alignItems:'center',justifyContent:'center'}}><Text>Cadastro de novos clientes em breve.</Text></View>);}
...
function ClienteStack() {
  return (
    <ClienteStackNav.Navigator>
          <ClienteStackNav.Screen name="SplashCliente" component={SplashCliente} options={{ headerShown: false }} />
...
const styles = StyleSheet.create({
  ...
  modeTxt: { color: '#fff', fontWeight: '700' },
      modeBtnSecondary:{ backgroundColor:'transparent', borderColor:'#2D5BFF', borderWidth:1, paddingVertical:14, paddingHorizontal:18, borderRadius:14 },
      modeTxtSecondary:{ color:'#2D5BFF', fontWeight:'700' }
});
